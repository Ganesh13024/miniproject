...
def show_classimage(Train,c,cname):
    ...
    fpath0= os.path.join(BASE_DIR,"DeepRetinopathy\\dbase\\")+ cls['image'].iloc[0] +".jpeg" 
    fpath1= os.path.join(BASE_DIR,"DeepRetinopathy\\dbase\\")+ cls['image'].iloc[1] +".jpeg" 
    fpath2= os.path.join(BASE_DIR,"DeepRetinopathy\\dbase\\")+ cls['image'].iloc[2] +".jpeg" 
    fpath3= os.path.join(BASE_DIR,"DeepRetinopathy\\dbase\\")+ cls['image'].iloc[3] +".jpeg" 
...
def readfeatures(cls,K):
    ...
    for num,fname in enumerate(cls['image'],start=0):            
        hfc1[num,:]=hogfeatures2(os.path.join(BASE_DIR,"DeepRetinopathy\\dbase\\"),fname)      
        hfc2[num,:]=dogfeatures2(os.path.join(BASE_DIR,"DeepRetinopathy\\dbase\\"),fname)    
        if ( num+1 >= K ):
            break;
...
def predection():
    Labels = pd.read_csv(os.path.join(BASE_DIR,"DeepRetinopathy\\Labels.csv"))
    ...
    xdata[0,0:63] =hogfeatures2(os.path.join(BASE_DIR,"DeepRetinopathy\\"),fname)      
    xdata[0,63:126] =dogfeatures2(os.path.join(BASE_DIR,"DeepRetinopathy\\"),fname)         
